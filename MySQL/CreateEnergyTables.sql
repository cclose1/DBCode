...
('Solar',  'Line',  'Produced',  1, 'Blue,KwhPerDay'),
('Solar',  'Line',  'Used',      2, 'Yellow,KwhUsedPerDay'),
('Solar',  'Line',  'Exported',  3, 'Green,KwhExportedPerDay'),
('Solar',  'Line',  '%Exported', 4, 'Red,%Exported');
